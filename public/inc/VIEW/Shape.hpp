...
public:
   ...
   * @param file Source file for fatal logs. 
   * @param line Source line for fatal logs. 
   * */
  ...
  /** @brief Get stride. 
   * @param index Dimension index. 
   * @return Stride value in elements. 
   * */
  ...
  /** @brief Replace dimensions and recompute strides. 
   * @param dims Dimension array. 
   * @param file Source file for fatal logs. 
   * @param line Source line for fatal logs. 
   * */
  ...
  /** @brief Replace rank and recompute strides. 
   * @param rank Number of active dimensions. 
   * @param file Source file for fatal logs. 
   * @param line Source line for fatal logs. 
   * */
  ...
  /** @brief Get max supported rank. 
   * @return VIEW::MAX_RANK. 
   * */
  int getMaxRank() const;

  /** @brief Convert indices to byte offset. 
   * @param i First index. 
   * @param j Second index. 
   * @param k Third index. 
   * @param l Fourth index. 
   * @return Byte offset for the indexed element. 
   * */
  int getSuperPosition(int i = 0, int j = 0, int k = 0, int l = 0) const;

  /** @brief Replace dimensions, rank, and dtype. 
   * @param dims Dimension array. 
   * @param rank Number of active dimensions. 
   * @param dtype Element type. 
   * @param file Source file for fatal logs. 
